...
class PodcastDetailsFragment : Fragment() {
  ...
  //Allows feed title to scroll and initializes the recycler view
  ...
  //uses the view data to populate the title and
  //description TextView elements, as well as load the podcast image using Glide.
